...
def build_parser() -> argparse.ArgumentParser:
    ...
    ingest.add_argument("--embedding-model", default="all-MiniLM-L6-v2", help="Embedding model name")
    ...
    ask.add_argument("--embedding-model", default="all-MiniLM-L6-v2", help="Embedding model name")
    ask.add_argument("--llm-model", default="llama-3.1-8b-instant", help="LLM model name")
    ask.add_argument(
        "--reference-answer",
        default=None,
    ...
    evaluate.add_argument("--embedding-model", default="all-MiniLM-L6-v2", help="Embedding model name")
    evaluate.add_argument("--llm-model", default="llama-3.1-8b-instant", help="LLM model name")
